#(Challenge: Approximating the Mathematical Constant ) Write a script that computes the value of π from the following infinite series. Print a table that shows the value of
